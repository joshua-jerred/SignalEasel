...
TEST(TelemetryTranscoder_test, encodeDataReportMessage_default) {
  ...
  EXPECT_TRUE(transcoder.encodeDataReportMessage(packet));
...
TEST(TelemetryTranscoder_test, encodeDataReportMessage_setValues) {
  ...
  transcoder.setSequenceNumber(100);
  transcoder.getAnalog(AnalogParameter::Id::A1).setRawValue(0);
  transcoder.getAnalog(AnalogParameter::Id::A2).setRawValue(10);
  transcoder.getAnalog(AnalogParameter::Id::A3).setRawValue(100);
  transcoder.getAnalog(AnalogParameter::Id::A4).setRawValue(255);
  transcoder.getAnalog(AnalogParameter::Id::A5).setRawValue(99);

  transcoder.getDigital(DigitalParameter::Id::B1).setValue(true);
  transcoder.getDigital(DigitalParameter::Id::B2).setValue(false);
  transcoder.getDigital(DigitalParameter::Id::B3).setValue(false);
  transcoder.getDigital(DigitalParameter::Id::B4).setValue(false);
  transcoder.getDigital(DigitalParameter::Id::B5).setValue(false);
  transcoder.getDigital(DigitalParameter::Id::B6).setValue(true);
  transcoder.getDigital(DigitalParameter::Id::B7).setValue(false);
  transcoder.getDigital(DigitalParameter::Id::B8).setValue(true);
...
TEST(TelemetryTranscoder_test, encodeParameterNameMessage_setAnalogName) {
  ...
  transcoder.getAnalog(AnalogParameter::Id::A1).setName("A1");
  ...
  transcoder.getAnalog(AnalogParameter::Id::A3).setName("A3");
  transcoder.encodeParameterNameMessage(packet);
  packet_string = std::string(packet.begin(), packet.end());
  EXPECT_EQ(packet_string, "PARM.A1,,A3");

  transcoder.getAnalog(AnalogParameter::Id::A2).setName("A2");
  transcoder.encodeParameterNameMessage(packet);
  packet_string = std::string(packet.begin(), packet.end());
  EXPECT_EQ(packet_string, "PARM.A1,A2,A3");

  transcoder.getAnalog(AnalogParameter::Id::A4).setName("A4");
  transcoder.getAnalog(AnalogParameter::Id::A5).setName("A5");
  transcoder.encodeParameterNameMessage(packet);
  packet_string = std::string(packet.begin(), packet.end());
...
TEST(TelemetryTranscoder_test, encodeParameterNameMessage_setDigitalName) {
  ...
  transcoder.getDigital(DigitalParameter::Id::B1).setName("B1");
  ...
  transcoder.getDigital(DigitalParameter::Id::B3).setName("B3");
  transcoder.encodeParameterNameMessage(packet);
  packet_string = std::string(packet.begin(), packet.end());
  EXPECT_EQ(packet_string, "PARM.x,,,,,B1,,B3");

  transcoder.getDigital(DigitalParameter::Id::B2).setName("B2");
  transcoder.getDigital(DigitalParameter::Id::B4).setName("B4");
  transcoder.getDigital(DigitalParameter::Id::B5).setName("B5");
  transcoder.getDigital(DigitalParameter::Id::B6).setName("B6");
  transcoder.getDigital(DigitalParameter::Id::B7).setName("B7");
  transcoder.getDigital(DigitalParameter::Id::B8).setName("B8");
...
TEST(TelemetryTranscoder_test, encodeParameterNameMessage_setAllNames) {
  ...
  transcoder.getAnalog(AnalogParameter::Id::A1).setName("aaaaaaa");
  transcoder.getAnalog(AnalogParameter::Id::A2).setName("aaaaaa");
  transcoder.getAnalog(AnalogParameter::Id::A3).setName("aaaaa");
  transcoder.getAnalog(AnalogParameter::Id::A4).setName("aaaaa");
  transcoder.getAnalog(AnalogParameter::Id::A5).setName("aaaa");

  transcoder.getDigital(DigitalParameter::Id::B1).setName("bbbbb");
  transcoder.getDigital(DigitalParameter::Id::B2).setName("bbbb");
  transcoder.getDigital(DigitalParameter::Id::B3).setName("bbb");
  transcoder.getDigital(DigitalParameter::Id::B4).setName("bbb");
  transcoder.getDigital(DigitalParameter::Id::B5).setName("bbb");
  transcoder.getDigital(DigitalParameter::Id::B6).setName("bb");
  transcoder.getDigital(DigitalParameter::Id::B7).setName("bb");
  transcoder.getDigital(DigitalParameter::Id::B8).setName("bb");
...
TEST(TelemetryTranscoder_test, encodeUnitAndLabelMessage_setAnalogUnit) {
  ...
  transcoder.getAnalog(AnalogParameter::Id::A1).setUnitOrLabel("A1");
  ...
  transcoder.getAnalog(AnalogParameter::Id::A3).setUnitOrLabel("A3");
  transcoder.encodeUnitAndLabelMessage(packet);
  packet_string = std::string(packet.begin(), packet.end());
  EXPECT_EQ(packet_string, "UNIT.A1,,A3");

  transcoder.getAnalog(AnalogParameter::Id::A2).setUnitOrLabel("A2");
  transcoder.encodeUnitAndLabelMessage(packet);
  packet_string = std::string(packet.begin(), packet.end());
  EXPECT_EQ(packet_string, "UNIT.A1,A2,A3");

  transcoder.getAnalog(AnalogParameter::Id::A4).setUnitOrLabel("A4");
  transcoder.getAnalog(AnalogParameter::Id::A5).setUnitOrLabel("A5");
  transcoder.encodeUnitAndLabelMessage(packet);
  packet_string = std::string(packet.begin(), packet.end());
...
TEST(TelemetryTranscoder_test, encodeUnitAndLabelMessage_setDigitalLabel) {
  ...
  transcoder.getDigital(DigitalParameter::Id::B1).setUnitOrLabel("B1");
  ...
  transcoder.getDigital(DigitalParameter::Id::B3).setUnitOrLabel("B3");
  transcoder.encodeUnitAndLabelMessage(packet);
  packet_string = std::string(packet.begin(), packet.end());
  EXPECT_EQ(packet_string, "UNIT.x,,,,,B1,,B3");

  transcoder.getDigital(DigitalParameter::Id::B2).setUnitOrLabel("B2");
  transcoder.getDigital(DigitalParameter::Id::B4).setUnitOrLabel("B4");
  transcoder.getDigital(DigitalParameter::Id::B5).setUnitOrLabel("B5");
  transcoder.getDigital(DigitalParameter::Id::B6).setUnitOrLabel("B6");
  transcoder.getDigital(DigitalParameter::Id::B7).setUnitOrLabel("B7");
  transcoder.getDigital(DigitalParameter::Id::B8).setUnitOrLabel("B8");
...
TEST(TelemetryTranscoder_test,
  ...
  TelemetryTranscoder transcoder;
  transcoder.getAnalog(AnalogParameter::Id::A1).setCoefficients("1", "2", "3");
  ...
  transcoder.getAnalog(AnalogParameter::Id::A5).setCoefficients("0", "0", "0");
...
TEST(TelemetryTranscoder_test, encodeBitSenseMessage_setBitSense) {
  ...
  TelemetryTranscoder transcoder;
  transcoder.getDigital(DigitalParameter::Id::B1).setBitSense(false);
  transcoder.getDigital(DigitalParameter::Id::B2).setBitSense(true);
  transcoder.getDigital(DigitalParameter::Id::B3).setBitSense(true);
  transcoder.getDigital(DigitalParameter::Id::B4).setBitSense(true);
  transcoder.getDigital(DigitalParameter::Id::B5).setBitSense(false);
  transcoder.getDigital(DigitalParameter::Id::B6).setBitSense(true);
  transcoder.getDigital(DigitalParameter::Id::B7).setBitSense(false);
  transcoder.getDigital(DigitalParameter::Id::B8).setBitSense(true);
...
TEST(TelemetryTranscoder_test, encodeBitSenseMessage_projectTitle) {
  ...
  TelemetryTranscoder transcoder;
  transcoder.setProjectTitle("Test Project");
