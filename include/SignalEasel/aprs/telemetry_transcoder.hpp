...
class TelemetryTranscoder : public TelemetryData {
public:
  /// @brief Default constructor.
  TelemetryTranscoder() = default;
  ...
  /// otherwise.
  bool encodeDataReportMessage(std::vector<uint8_t> &output) const;
  ...
  /// @return \c true if the message was successfully encoded, \c false
  /// otherwise.
  bool encodeParameterCoefficientMessage(std::vector<uint8_t> &output) const;
  ...
  /// @return \c true if the message was successfully encoded, \c false
  /// otherwise.
  bool encodeParameterNameMessage(std::vector<uint8_t> &output) const;
  ...
  /// @return \c true if the message was successfully encoded, \c false
  /// otherwise.
  bool encodeUnitAndLabelMessage(std::vector<uint8_t> &output) const;
  ...
  /// @return \c true if the message was successfully encoded, \c false
  /// otherwise.
  bool encodeBitSenseMessage(std::vector<uint8_t> &output) const;
...
private:
  ...
  /// @param message - The message to decode.
  /// @return \c true if the message was decoded, \c false if not.
  bool decodeParameterCoefficientMessage(const std::vector<uint8_t> &message);

  /// @brief Decode the bit sense / project name message.
  /// @param message - The message to decode.
  /// @return \c true if the message was decoded, \c false if not.
  bool decodeBitSenseMessage(const std::vector<uint8_t> &message);
};
